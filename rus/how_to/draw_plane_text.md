...
Флаг `draw_planetext.end` это сообщение программе о том, что нужно остановить загрузку символов и закончить выполнение программы. То есть просто `exit the program`
